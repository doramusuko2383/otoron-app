...
export function renderHelpScreen() {
  ...
  main.innerHTML = `
    <section id="help-section" class="help-container">
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">対象年齢と基礎的な考え方</button>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">相対音感との関係と注意点</button>
        <div class="help-answer" hidden>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">トレーニング環境と頻度</button>
        <div class="help-answer" hidden>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">回答方法と進行の流れ</button>
        <div class="help-answer" hidden>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">合格条件と推奨出題数</button>
        <div class="help-answer" hidden>
          <p>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">音名表記と構成音の扱い</button>
        <div class="help-answer" hidden>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">白鍵終了後の流れと単音テスト</button>
        <div class="help-answer" hidden>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">単音分化トレーニングと移行条件</button>
        <div class="help-answer" hidden>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">黒鍵トレーニングと転回形の扱い</button>
        <div class="help-answer" hidden>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">最終テストと絶対音感の維持</button>
        <div class="help-answer" hidden>
      ...
      <div class="help-item">
        <button class="help-question" aria-expanded="false">このガイドについて</button>
        <div class="help-answer" hidden>
  ...
  const questionButtons = main.querySelectorAll("#help-section .help-question");
      ...
      if (expanded) {
        ...
        questionButtons.forEach((b) => {
          if (b !== btn) {
            ...
            const otherAns = b.nextElementSibling;
